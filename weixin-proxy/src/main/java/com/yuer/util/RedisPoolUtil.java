...
public class RedisPoolUtil {
	...
	// Redis服务器IP
	private static String ADDR = "47.104.175.0";
	// Redis的端口号
	private static Integer PORT = 6379;
	// 访问密码
	private static String AUTH = "chw";
	...
	public static void main(String[] args) {
		RedisPoolUtil.getJedis().set("name", "阿斯顿法国好几款");
		System.out.println(RedisPoolUtil.getJedis().get("name"));
	}
